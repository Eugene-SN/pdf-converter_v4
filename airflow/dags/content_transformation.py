...
def load_intermediate_data(**context) -> Dict[str, Any]:
    ...
    try:
        ...
        if not document_data or 'markdown_content' not in document_data:
            raise ValueError("Данные документа некорректны")
    ...
    try:
        ...
        if vllm_enabled and ENHANCEMENT_CONFIG['enable_vllm_enhancement']:
            ...
            for i, chunk in enumerate(content_chunks):
                ...
                if enhanced_chunk and enhanced_chunk != chunk:
            ...
            if enhanced_chunks:
                ...
                final_enhanced_content = merge_enhanced_chunks(enhanced_chunks)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    # повторная попытка только если остались ретраи
                ...
                # Сервер мог упасть на внутренней ошибке (например, неверный доступ к outputs.*)
